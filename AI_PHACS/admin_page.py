...
#### ==============================================================================================================#####
    ...
    #     Images
        ...
        address_field = Text(self.student_sub_entry2_frame, width=20, height=4, font=('times new roman', 15), bg='lightgray')
...
#### ==============================================================================================================#####
    ...
    def checkDetailClicked(self):
        ...
        backButton = Button(self.student_detail_frame, image=self.back, command=self.student_detail_backClicked, border=0,
                            height=65,
                            width=65, cursor='hand2', bg='white', activebackground='white')
        ...
        edit_address_field = Text(self.student_detail_frame, width=20, height=4, font=('times new roman', 12), bg='lightgray')
        ...
        self.student_data_table = ttk.Treeview(self.student_table_frame, columns=("enroll_no", "name", "perc", "phno", "email", "dob", "address"),
...
#### ==============================================================================================================#####
   ...
   #      attendance table with full daily info & percentage
    ...
    def checkAttendanceClicked(self):
        ...
        backButton = Button(self.student_attendance_frame, image=self.attendance_back, command=self.student_attendance_backClicked,
                            border=0,
                            height=65,
                            width=65, cursor='hand2', bg='white', activebackground='white')
        ...
        student_attendance_title = Label(student_attendance_banner_frame, text='Student Attendance', font=('Impact', 30, 'bold'),
                                     bg='#49a0ae',
                                     fg='white')
        ...
        #search
        attendance_search = Label(self.student_attendance_frame, text='Search By : ', font=('times new roman', 12), bg='white',
                     fg='black')
