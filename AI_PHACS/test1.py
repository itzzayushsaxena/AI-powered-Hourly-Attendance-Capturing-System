...
class Admin_Page:
    ...
    def create_widgets(self):
        ...
        logout_label = Label(self.banner_frame, text='Logout ', font=('times new roman', 12, 'bold'), bg='#49a0ae',
                             fg='white')
    ...
    def admin_template(self):
        ...
        self.checkUserDetailButton = Button(interior, image=self.detailPhoto, command=self.checkUserDetailClicked,
                                            border=0,
                                            height=120, width=120, cursor='hand2', )
        self.checkUserDetailButton.pack(padx=0, pady=5, side=TOP)
    ...
    def checkUserDetailClicked(self):
        pass
